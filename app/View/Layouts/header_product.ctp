...
<head>
    ...
    echo $this->Html->meta('description', isset($head_description)? $head_description: 'Chợ đồ cũ, hàng thanh lý');
...
<div class="container hidden-xs" style="padding-top: 10px; padding-bottom: 10px">
    <div class="row">
        <div class="col-sm-3 text-left">
            <a href="/"><img src="/img/logo1.png" alt="Kênh rao vặt miễn phí" height="70px"></a>
        </div>
        <div class="col-sm-5">
            <div class="div-image-top"><img src="/uploads/advertise/adv_top.png" height="40px"></div>
            <div style="padding-top: 10px">
                ...
                {
                    ?>
                    <span class="blue bolder"><?php echo $breadcrumb_province['Province']['provincename'];?></span>
                    <?php
                }
                else
                {
                    ?>
                    <span class="blue bolder">Toàn quốc</span>
                    <?php
                }
                ?>
                |
                <a href="#" class="dropdown-toggle a-mega-menu" data-toggle="dropdown">
                    Khác
                </a>
                <ul class="dropdown-menu mega-dropdown-menu row">
                    <?php
                    $location_link = isset($this->params['location'])? $this->params['location']: 'toan-quoc';
                    if(isset($province_location))
                    {
                        foreach ($province_location as $key => $value)
                        {
                            ?>
                            <li class="li-location col-md-3 col-sm-6">
                                <a class="<?php if($location_link == $key) { echo 'bolder';}?>" href="/rao-vat/<?php echo $key;?>/<?php echo $category_link;?>"><?php echo $value;?></a>
                            </li>
                            <?php
                        }
                        ?>
                        <li class="li-location col-md-3 col-sm-6">
                            <a class="<?php if($location_link == 'toan-quoc') { echo 'bolder';}?>" href="/rao-vat/toan-quoc/<?php echo $category_link;?>">
                                Toàn quốc +
                            </a>
                        </li>
                        <?php
        ...
        <div class="collapse navbar-collapse js-navbar-collapse">
            <div class="container">
                <ul class="hidden-xs nav navbar-nav">
                    <li>
                        <a href="/rao-vat/toan-quoc/mua-ban">Hàng thanh lý</a>
                    </li>
                </ul>
                <!--Ul profile-->
                <?php
                ...
                {
                    ?>
                    <div class="nav navbar-nav navbar-right navbar-profile" style="padding-top: 7px">
                        <a class="btn btn-success btn-white btn-round" href="/members/login">
                            <i class="fa fa-key"></i>
                            <?php echo __('Login');?>
                        </a>
                        <a class="btn btn-success btn-white btn-round" href="/members/register">
                            <i class="fa fa-user"></i>
