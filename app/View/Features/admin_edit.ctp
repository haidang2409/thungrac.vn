                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            ...
                            ?>
                            <?php echo $this->Form->input('category_id', array('type' => 'select', 'label' => false, 'options' => $categories, 'class' => 'form-control', 'empty' => ' -- Chọn chuyên mục -- ', 'default' => $features['Feature']['category_id']));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="categoryname" class="col-sm-4 control-label">Tên đặc điểm/Chuyên ngành/Hãng xs</label>
                        <div class="col-sm-8">
                            <?php echo $this->Form->input('feature', array('type' => 'text', 'label' => false, 'class' => 'form-control', 'value' => $features['Feature']['feature']));?>
                            <?php echo $this->Form->input('id', array('label' => false, 'class' => 'form-control', 'value' => $features['Feature']['id']));?>
                        </div>
                    </div>
