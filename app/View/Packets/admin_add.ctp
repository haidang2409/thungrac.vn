                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <?php echo $this->Form->input('packetname', array('type' => 'text', 'class' => 'form-control', 'label' => false));?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3 col-xs-12">
                            <?php echo $this->Form->input('date', array('type' => 'text', 'class' => 'form-control', 'label' => false));?>
                        </div>
