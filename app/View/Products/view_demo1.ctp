           ...
           <div class="row">
               ...
               if($sum_image > 0)
               {
                   ...
                   <div class="col-sm-12">
                       ...
                       <script async src="https://cdnjs.cloudflare.com/ajax/libs/lightslider/1.1.3/js/lightslider.min.js"></script>
                       <script>
                           $(function () {
                       ...
                       <div class="demo">
                           <ul id="lightSlider">
                               ...
                               {
                                   $img = '/uploads/products/' . $images[$i]['Image']['imagedir'] . '/' . $images[$i]['Image']['imagelink'];
                                   ?>
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="vertical-align: middle; text-align: center">
                                <?php
                                $fullname = $product['Member']['fullname'];
...
<!--            Rating-->
            <div class="">
                <img src="/uploads/advertise/tenten3.jpg" width="100%">
            </div>
