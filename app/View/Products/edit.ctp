                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <?php
                                        echo $this->Form->input('parent_id', array('id' => 'parent_id', 'type' => 'select', 'options' => $parents, 'label' => false, 'empty' => ' -- Chọn loại -- ', 'style' => 'width: 100% !important', 'default' => $product['Parent']['id']))
                                        ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <?php
                                        echo $this->Form->input('category_id', array('id' => 'category_id', 'type' => 'select', 'label' => false, 'empty' => ' -- Chọn -- ', 'options' => $categories, 'style' => 'width: 100% !important', 'default' => $product['Category']['id']))
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        ...
                                        echo $this->Form->input('price', array('id' => 'price', 'label' => false, 'class' => 'form-control', 'type' => 'text', 'value' => $product['Product']['price'], 'readonly' => $pri_deal))
                                        ?>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-sm-offset-6">
                                        ...
                                        <div class="checkbox" style="">
                                            <label style="padding-left: 10px !important;">
                                                ...
                                                ?>
                                                <input name="data[Product][deposit]" value="1" class="ace ace-checkbox-2" type="checkbox" <?php echo $deposit;?>>
...
<script>
    $(function () {
        var price_old = '<?php echo $product['Product']['price'];?>';
