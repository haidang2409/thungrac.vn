            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label for="username" class="col-sm-4 control-label">Nhóm danh mục</label>
                        <div class="col-sm-4 col-xs-12">
                            <?php echo $this->Form->input('parent_id', array('type' => 'select', 'label' => false, 'options' => $parents, 'class' => 'form-control', 'empty' => ' -- Chọn nhóm -- '));?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo $this->Form->input('sort', array('label' => false, 'class' => 'form-control', 'type' => 'text'));?>
                        </div>
                    </div>
